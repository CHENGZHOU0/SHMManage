													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="monitoring?pid=${project.id}">
																	选择
																</a>
															</div>
														</td>
														...
														<td>
															...
															<c:if test="${userType == 'administrator'}">	
																<div class="hidden-sm hidden-xs action-buttons">
																	...
																	<a class="green" href="edit_project?pid=${project.id}">
																		<i class="ace-icon fa fa-pencil bigger-130"></i>
																	</a>
		
																	<a class="red" href="delete_project?pid=${project.id}">
										...
										<div class="col-sm-6">
											<div class="widget-box">
												<div class="widget-header widget-header-flat">
													<h4 class="widget-title">新增项目</h4>
												</div>
		
												<div class="widget-body" align="center">
													<form class="form-horizontal" method="post" id="addForm" action="add_project">
											            ...
											            <div class="form-group">
															...
															<div class="col-sm-9">
																<input type="text" name="name" placeholder="项目名称" class="col-xs-10 col-sm-9" />
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input type="text" name="address" placeholder="项目地址" class="col-xs-10 col-sm-9" />
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input type="text" name="fileid" placeholder="fileId" class="col-xs-10 col-sm-9" />
															</div>
														</div>
		...
		<script type="text/javascript">
			...
			$(function(){
			    ...
			    $("#addForm").submit(function(){
			        if(!checkEmpty("name","项目名称"))
			            return false;
			        if(!checkEmpty("address","项目地址"))
			            return false;
