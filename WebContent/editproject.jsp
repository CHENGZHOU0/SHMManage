									...
									<div class="col-sm-6">
										<div class="widget-box">
											<div class="widget-header widget-header-flat">
												<h4 class="widget-title">编辑项目信息</h4>
											</div>
	
											<div class="widget-body" align="center">
												<form class="form-horizontal" method="post" id="addForm" action="update_project?pid=${pid }">
													
										            <div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 项目名称：  </label>
						
														<div class="col-sm-9">
															<input type="text" id="form-field-1" name="name" value=${project.name } class="col-xs-10 col-sm-9" />
														</div>
													</div>
													
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 项目地址：  </label>
						
														<div class="col-sm-9">
															<input type="text" id="form-field-1" name="address" value=${project.address } class="col-xs-10 col-sm-9" />
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-xs-8 col-sm-6">
															<div class="input-group">	
																<input class="form-control date-picker" name="date-picker" type="text" data-date-format="dd-mm-yyyy" />
													...
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> fileId：  </label>
						
														<div class="col-sm-9">
															<input type="text" id="form-field-1" name="fileid" value=${project.fileId } class="col-xs-10 col-sm-9" />
														</div>
													</div>
