								...
								<div class="center">
										...
										<div class="container">
											<div class="row">
												...
												<form action="monitoring_data_query?pid=${pid }" method="post">
													<div class="col-xs-2">
													...
													<div class="col-xs-3">
														...
														<label for="form-field-select-1">查询数据类型</label>
													
														<select class="form-control" id="form-field-select-1" name="valuetype">
			...
			var viewToken = "${viewToken}";
		  	...
		  	function successCallback(viewMetaData) {
		        ...
		        viewer3D.addEventListener(Glodon.Bimface.Viewer.Viewer3DEvent.MouseClicked, function (objectdata) {
		            ...
		            //alert(JSON.stringify(objectdata));
		  			...
		  			{
		  		  		//document.getElementById("sensor").value = "1"
		  	...
		  	function zoomToSelectedComponents(){
				...
				//创建XHR对象
			  	...
			  	//open()设置请求
			  	xhr.open("GET","<%=basePath %>newest_data?sid="+id,true);
			  	
			  	//alert("<%=basePath %>newest_data");
			  	...
			  	*/
			  	...
			  	xhr.onreadystatechange = function(){
			  		...
			  		if(xhr.readyState == 4 && xhr.status == 200){
			  			...
			  			document.getElementById("p1").childNodes[0].nodeValue = obj.x
			  			document.getElementById("p2").childNodes[0].nodeValue = obj.y
			  			document.getElementById("p3").childNodes[0].nodeValue = obj.t
			  		}
			  	};
		  	...
		  	function overrideComponents(){
		    	if (!isOverrideActivated) {
		      		...
		      		var color = new Glodon.Web.Graphics.Color("#00008B", 1);
		      		...
		      		// 对关注构件进行着色
		      		viewer3D.overrideComponentsColorById(arrElementId, color);
		      		viewer3D.render();
		      		...
		      		viewer3D.render();
		      		setButtonText("btnOverrideColor", "传感器着色");
		    	}
